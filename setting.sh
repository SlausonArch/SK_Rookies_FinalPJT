...
LOCAL_EXCHANGE_FRONTEND_URL="${LOCAL_EXCHANGE_FRONTEND_URL:-http://localhost:15173}"
LOCAL_BANK_FRONTEND_URL="${LOCAL_BANK_FRONTEND_URL:-http://localhost:15174}"
LOCAL_FRONTEND_URL="${LOCAL_FRONTEND_URL:-$LOCAL_EXCHANGE_FRONTEND_URL}"
LOCAL_CORS_ALLOWED_ORIGINS="${LOCAL_CORS_ALLOWED_ORIGINS:-$LOCAL_EXCHANGE_FRONTEND_URL,$LOCAL_BANK_FRONTEND_URL}"
...
LOCAL_API_BASE_URL="${LOCAL_API_BASE_URL:-http://localhost:18080}"
LOCAL_SERVER_ACTION_ALLOWED_ORIGINS="${LOCAL_SERVER_ACTION_ALLOWED_ORIGINS:-$LOCAL_EXCHANGE_FRONTEND_URL,$LOCAL_BANK_FRONTEND_URL}"
...
KAKAO_REDIRECT_URI=${LOCAL_API_BASE_URL}/login/oauth2/code/kakao
NAVER_REDIRECT_URI=${LOCAL_API_BASE_URL}/login/oauth2/code/naver
...
NEXT_PUBLIC_EXCHANGE_FRONTEND_URL=${LOCAL_EXCHANGE_FRONTEND_URL}
NEXT_PUBLIC_BANK_FRONTEND_URL=${LOCAL_BANK_FRONTEND_URL}
NEXT_SERVER_ACTION_ALLOWED_ORIGINS=${LOCAL_SERVER_ACTION_ALLOWED_ORIGINS}
EOT
}
